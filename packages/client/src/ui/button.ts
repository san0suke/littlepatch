...
const PALETTES: Record<ButtonVariant, Palette> = {
  primary: { fill: 0xf6c453, fillAlpha: 1, stroke: 0x4a3728, text: '#3a2a17' },
  ghost: { fill: 0xfdf6e3, fillAlpha: 0.92, stroke: 0x4e8a3c, text: '#2f3b2c' },
  disabled: { fill: 0xfdf6e3, fillAlpha: 0.5, stroke: 0xa9b8a2, text: '#8b9a86' },
};
